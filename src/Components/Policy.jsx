    ...
    return (
        <div className='mt-16 px-6 md:px-14 lg:px-28'>
          ...
          <div className='flex flex-col gap-6 '>
             <p className='text-base font-normal text-zinc-600'>Stylist Hair takes your privacy seriously. This privacy policy covers the treatment of personally identifiable information that site collects when you are on the Stylist Hair site. By visiting US, you are accepting the practices described in this privacy policy.</p>
             ...
             StylistHair.com collects your information when you make a purchase, visit the site, search, post, complete a questionnaire, or register for a StyleHair.com account. Through these actions, you may provide us with your name, address, phone number, email address, zip code, birth date, occupation, gender, credit card information, and personal interests. We use this information to respond to your requests, customize your future shopping experience, advertise, improve our stores, and communicate with you.
             </p>
             ...
             <p className='text-base font-normal text-zinc-600'>
             StylistHair.com will not sell your information to anyone. StylistHair.com may share your information with other companies or individuals when: we have your consent to share the information; we need to share your information to provide the product or service you have requested; or we need to send the information to companies who work on behalf of StylistHair.com to provide a product or service to you.
             </p>
             <h1 className='text-3xl font-bold text-[#2A0134]'>Cookies</h1>
             <p className='text-base font-normal text-zinc-600'>Stylist Hair may set and access cookies on your computer.</p>
             <h1 className='text-3xl font-bold text-[#2A0134]'>Changes of Privacy Policy</h1>
             <p className='text-base font-normal text-zinc-600'>Stylist Hair may amend this policy from time to time. If we make any substantial changes in the way we use your personal information we will notify you by posting a prominent announcement on our pages.</p>
             <h1 className='text-3xl font-bold text-[#2A0134]'>Minors</h1>
             <p className='text-base font-normal text-zinc-600'>By using StylistHair.com, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you have given us your</p>
